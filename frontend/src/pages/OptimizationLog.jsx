...
export default function OptimizationLog() {
  ...
  useEffect(() => { getOptimizationLog(200).then(setItems).catch(() => {}); }, []);
  ...
  return (
    <div data-testid="page-optimization">
      <PageHeader title="Optimization Log" subtitle="Before / after token counts, compression ratio, and quality delta for every optimized request." testId="opt-header" />
